...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../../admin/management">Home</a>
                    </li>
                    <c:if test="${okb.firstName != null}">
		...
		<div class="row">
						...
						<form action='../../sendtojudge' method="GET">
							<div class="card-body">
								...
								<div id="chooseJudge">
									...
									<input type="text" class="form-control mt-2" id="judNames" name="judgeNames" hidden>
									<input type="hidden" name="reportID" value="${report.reportID}">
									<hr>
									<div class="form-group mb-2">
										<label for="endTimeInput">End Time: <span id="showTime2"></span></label>
										<input class="form-control form-control-sm" type="number" min="01" max="10" id="endTimeInput" value="01">
									</div>
									<input  type="Text" name="endTime" id="showTime" hidden required>
								</div>
							</div>
			...
			<c:if test="${type == 'send' or type == 'decision' or type == 'result'}">
				<div class="col-lg-12 mx-auto">
					<div class="card bg-light mt-4">
			...
			<c:if test="${type == 'decision'}">
				<div class="col-lg-12 mx-auto">
					<div class="card bg-light mt-4">
						<div class="card-body">
							<div class="btn-group btn-block" role="group" aria-label="Basic example">
								<a href="../../makeDecision?decision=1&reportID=${report.reportID}" class="btn btn-outline-success">Accept</a>
								<a href="../../makeDecision?decision=0&reportID=${report.reportID}" class="btn btn-outline-danger">Reject</a>
							</div>
						</div>
					</div>
				</div>
